...
- **Build Outside New Sirocco**: If true, allows you to place buildings anywhere outside of New Sirocco. Default is false. **WARNING**: Enabling this will prevent areas from expiring every 7 days, which means enemies will not respawn/despawn and some aspects of the game might break.
